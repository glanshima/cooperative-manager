...
def decide_application(
    ...
    if payload.approved:
        ...
        interest_amount, total_repayable, monthly_installment = compute_loan_terms(
            payload.approved_amount, loan_type.interest_rate, loan_type.flat_charge, loan_type.tenure_months
        )
        disbursement_date = date.today()
        expected_end_date = compute_expected_end_date(disbursement_date, loan_type.tenure_months)
        ...
        send_email(
            ...
            html=loan_approved_email_html(
                ...
                total_repayable=total_repayable,
                monthly_installment=monthly_installment,
                tenure_months=loan_type.tenure_months,
                disbursement_date=disbursement_date,
                expected_end_date=expected_end_date,
